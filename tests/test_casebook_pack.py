"""Regression checks for the sonar-model-metric-grid casebook."""
...
from casebook.harness import assert_expected, sonar_model_metric_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_model_metric_grid_summary(), assert_expected())
